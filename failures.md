...
E    +  where 'lmstudio' = <app.config.Settings object at 0x000002D079BDD940>.LLM_PROVIDER
...
E   AssertionError: assert 'lmstudio' in ('ollama', 'openai')
E    +  where 'lmstudio' = <app.services.llm_service.LLMService object at 0x000002D07A6C5180>.provider
============================== warnings summary ===============================
...
8 failed, 217 passed, 2 warnings in 15.20s
