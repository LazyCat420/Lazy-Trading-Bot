...
class TickerValidator:
    ...
    EXCLUSION_LIST: set[str] = {
        ...
        "GUST", "GUYS", "HACK", "HAIR", "HALF", "HALL", "HALT",
        ...
        "PULL", "PURE", "PUSH", "QUIT", "RACE", "RAGE", "RAID",
        ...
        "RANCH", "RANGE", "RAPID", "RATIO", "REACH", "READY",
        ...
        "SWIFT", "SWING", "SWORD", "SWORE", "TABLE", "TAKEN",
        ...
        "WEIRD", "WHALE", "WHEAT", "WHEEL", "WHERE", "WHILE",
